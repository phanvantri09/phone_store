...
<div class="card">
    ...
    <div class="card-body card-block">
        <form action="{{route('admin.postaddBill')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">Sản phẩm</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="price" placeholder="Nhập sản phẩm " class="form-control">
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="email-input" name="numberPhone" placeholder="Nhập số (bắt buộc) " class="form-control">
                    @error('numberPhone')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
